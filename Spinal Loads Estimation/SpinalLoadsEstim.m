...
plot(t_100, L4L5_compression(1:(frames1/100):frames1));
hold on
plot(t_100, L4L5_compression2(1:(frames2/100):frames2));
...
frames1 =length(L4L5_compression);
frames2=length(L4L5_compression2);
plot(t_100, L4L5_shear(1:(frames1/100):frames1));
hold on
plot(t_100, L4L5_shear2(1:(frames2/100):frames2));
xlabel('% Lifting Cycle');
ylabel('Force (N)');
legend({'No exoskeleton','Exoskeleton'},'Location','best');
...
frames1 =length(L4L5_compression);
frames2=length(L4L5_compression2);
plot(t_100, L5S1_compression(1:(frames1/100):frames1));
hold on
plot(t_100, L5S1_compression2(1:(frames2/100):frames2));
xlabel('% Lifting Cycle');
ylabel('Force (N)');
legend({'No exoskeleton','Exoskeleton'},'Location','best');
...
frames1 =length(L4L5_compression);
frames2=length(L4L5_compression2);
plot(t_100, L5S1_shear(1:(frames1/100):frames1));
hold on
plot(t_100, L5S1_shear2(1:(frames2/100):frames2));
xlabel('% Lifting Cycle');
ylabel('Force (N)');
legend({'No exoskeleton','Exoskeleton'},'Location','best');
