...
X = [];
for i = 1:(idxF1-idxO1+1) % should be changed when calculating another phase
...
PS = table([1; AP_dev_mean;  ML_dev_mean;  Total_dev_mean; PosturalStability_AP; PosturalStability_ML],'VariableNames',{'Postural Stability Measures'},'RowNames',{'Phase','Average A/P Deviation (mm)','Average M/L Deviation (mm)','Average Total Deviation (mm)','Postural Stability (A/P)','Postural Stability(M/L)'})